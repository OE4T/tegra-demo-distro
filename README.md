...
![Build status](https://builder.madison.systems/badges/tegrademo-styhead.svg)

Metadata layers are brought in as git submodules:

| Layer Repo            | Branch         | Description                                         |
| --------------------- | ---------------|---------------------------------------------------- |
| poky                  | styhead        | OE-Core from poky repo at yoctoproject.org          |
| meta-tegra            | styhead        | L4T BSP layer - L4T R36.4.0/JetPack 6.1             |
| meta-tegra-community  | styhead        | OE4T layer with additions from the community        |
| meta-openembedded     | styhead        | OpenEmbedded layers                                 |
| meta-virtualization   | styhead        | Virtualization layer for docker support             |
