...
run_video_dec_trt() {
    ...
    video_dec_trt 2 "$SAMPLEVID" "$SAMPLEVID" H264 --trt-deployfile "$SAMPLEROOT/data/Model/resnet10/resnet10.prototxt" \
		  --trt-modelfile "$SAMPLEROOT/data/Model/resnet10/resnet10.caffemodel" --trt-mode 0 || rc=1
...
TESTS="$TESTS camera_v4l2_cuda decode_sample encode_sample transform_sample"
