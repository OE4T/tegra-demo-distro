...
VPI, TensorRT and Tegra multimedia API sample apps."
...
CORE_IMAGE_BASE_INSTALL += "libvisionworks-devso-symlink nvidia-docker cuda-libraries tegra-mmapi-samples vpi1-tests tensorrt-tests"
