...
# Audio: PulseAudio daemon (includes pactl), and other control utilities, full ALSA utils suite
RDEPENDS:${PN} += "${@bb.utils.contains('DISTRO_FEATURES', 'pulseaudio', 'pulseaudio-server pulseaudio-misc', '', d)}"
